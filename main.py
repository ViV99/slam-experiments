...
class BruteForceFeatureMatcher(FeatureMatcher):
    ...
    def match_features(
        ...
        return self.bf.match(query_descriptors, source_descriptors)
...
def main():
    ...
    matches = bf_matcher.match_features(des1, des2)
    bf_matcher.draw_matches(img1, kp1, img2, kp2, matches[:50])
    cv2.waitKey()
